namespace SalesForce.Pages
{
    ...
    public class OrganisationMassDeletePage : BasePage

    {
        #region Constructor
        public OrganisationMassDeletePage(IWebDriver Driver) : base(Driver)
        {
        }
        #endregion
        ...
        private By _labelHeadStep4 = By.XPath("//*[@id='head_mdStep4_ep']/h3");
        private By _labelHeadStep5 = By.XPath("//*[@id='head_mdStep5_ep']/h3");
        private By _labelHeadStep6 = By.XPath("//*[@id='head_mdStep6_ep']/h3");
        private By _chkBoxClosedOpp = By.XPath("//*[@id='closed_opp']");
        private By _chkBoxOwnerOpp = By.XPath("//*[@id='owner_opp']");
        ...
        private By _msgPostDelete = By.XPath("//*[@id='ep']/div[2]/div[13]/table/tbody/tr[2]/td/div[1]/div/div[2]/table/tbody/tr[2]/td");


        private By _chkBoxSearchOutputHeader = By.XPath("//*[@id='allBox']");

        private By _btnTopDelete = By.XPath("//*[@id='ep']/div[2]/div[13]/table/tbody/tr[2]/td/div/input");

        private By _btnBottomDelete = By.XPath("//*[@id='ep']/div[2]/div[13]/table/tbody/tr[4]/td/div/input");

        private By _tableSearchOutputData = By.XPath("//*[@id='ep']/div[2]/div[13]/table/tbody/tr[3]/td/div[1]/div/div[2]");
        #endregion
        ...
        public IWebElement HeadStep5Text
        {
            get
            {
                return driver.FindElement(_labelHeadStep5);
            }
        }
        public IWebElement HeadStep6Text
        {
            get
            {
                return driver.FindElement(_labelHeadStep6);
            }
        }
        public IWebElement ClosedOppCheckBox
        {
            get
            {
                return driver.FindElement(_chkBoxClosedOpp);
            }
        }
        public IWebElement OwnerOppCheckBox
        {
            get
            {
                return driver.FindElement(_chkBoxOwnerOpp);
            }
        }
        ...
        {
            Assert.AreEqual("Mass Delete: Accounts ~ Salesforce - Enterprise Edition", driver.Title);
            Assert.AreEqual("Step 1: Review what will happen when you mass delete your Accounts:", HeadStep1Text.Text);
            Assert.AreEqual("Step 2: Recommendation prior to mass deleting:", HeadStep2Text.Text);
            Assert.AreEqual("Step 3: Find Accounts that match the following criteria:", HeadStep3Text.Text);
            Assert.AreEqual("Step 4: Choose to delete Accounts with Closed-Won Opportunities", HeadStep4Text.Text);
        }
